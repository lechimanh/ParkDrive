        ...
        <div class="col-span-12 lg:col-span-9 2xl:col-span-10">
            ...
            <div class="intro-y flex flex-col-reverse sm:flex-row items-center">
                <div class="w-full sm:w-auto relative mr-auto mt-3 sm:mt-0">
                    ...
                    <input type="text" class="form-control w-full sm:w-64 box px-10" placeholder="Tìm kiếm" />
                    <Dropdown class="inbox-filter absolute inset-y-0 mr-3 right-0 flex items-center"
                ...
                <div class="w-full sm:w-auto flex">
                    ...
                    <Dropdown>
                        ...
                        <DropdownMenu class="w-40">
                            <DropdownContent>
                                <DropdownItem>
                                    <FileIcon class="w-4 h-4 mr-2" /> Chia sẻ
                                </DropdownItem>
                                <DropdownItem>
            ...
            <div class="intro-y grid grid-cols-12 gap-3 sm:gap-6 mt-5">
                <div v-for="(faker, fakerKey) in $f()" :key="fakerKey"
                    ...
                    <div class="file box rounded-md px-5 pt-8 pb-5 px-3 sm:px-5 relative zoom-in height">
                        ...
                        <a v-if="faker.files[0].type == 'Empty Folder'" href=""
                            class="w-3/5 file__icon file__icon--empty-directory mx-auto"></a>
                        <a v-else-if="faker.files[0].type == 'Folder'" href=""
                            class="w-3/5 file__icon file__icon--directory mx-auto"></a>
                        <a v-else-if="faker.files[0].type == 'Image'" href=""
                        ...
                        <Dropdown class="absolute top-0 right-0 mr-2 mt-3 ml-auto">
                            ...
                            <DropdownMenu class="w-40">
                                <DropdownContent>
                                    <DropdownItem>
                                        <UsersIcon class="w-4 h-4 mr-2" /> Chia sẻ
                                    </DropdownItem>
                                    <DropdownItem>
