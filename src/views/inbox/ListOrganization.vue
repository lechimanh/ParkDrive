      ...
      <div class="intro-y mt-2 form-search">
        <div class="search-layout">
          <div class="search-input-1">
            ...
            <TomSelect placeholder="Tất cả" class="w-44" v-model="dataSearch.organizationId">
...
export default {
  ...
  methods: {
    async init() {
      const res = await Remunerative.getRemuneratives(JSON.stringify({ type: 1 }));
    ...
    async showDetail(id) {
      ...
      let rewardedPersonId = this.dataDetail.type == 0 ? this.dataDetail.rewardedPerson?.id : null;
      remunerativeRemove.push(this.dataDetail.id);
      let data = {
        "remunerativeRemove": remunerativeRemove,
        "organizationId": organizationId,
        "rewardedPersonId": rewardedPersonId,
      }
